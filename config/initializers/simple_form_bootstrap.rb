module SimpleForm
  module Components
    module Icons
      ...
      def icon_class
        icon_tag = template.content_tag(:i, '', class: "fa #{options[:icon]} form-control-feedback")
      end
    end
  end
end
...
SimpleForm.setup do |config|
  ...
  config.wrappers :bootstrap_prepend, tag: 'div', class: 'form-group', error_class: 'has-error' do |b|
    b.use :html5
    b.use :placeholder
  ...
  config.wrappers :no_label, tag: 'div', class: 'form-group' do |b|
    b.use :html5
    b.use :placeholder
    b.use :input, class: 'form-control'
  end
  ...
  config.default_wrapper = :bootstrap_prepend
  config.wrapper_mappings = {
    check_boxes: :vertical_radio_and_checkboxes,
    radio_buttons: :vertical_radio_and_checkboxes,
    file: :bootstrap_prepend,
